...
type FakeRegistry struct {
	...
	LookupWithoutWildcardStub        func(uri route.Uri) *route.Pool
	lookupWithoutWildcardMutex       sync.RWMutex
	lookupWithoutWildcardArgsForCall []struct {
		uri route.Uri
	}
	lookupWithoutWildcardReturns struct {
		result1 *route.Pool
	}
	lookupWithoutWildcardReturnsOnCall map[int]struct {
		result1 *route.Pool
	}
	WalkNodesWithPoolStub        func(func(f *container.Trie))
	walkNodesWithPoolMutex       sync.RWMutex
	walkNodesWithPoolArgsForCall []struct {
		arg1 func(f *container.Trie)
	}
...
func (fake *FakeRegistry) LookupWithoutWildcard(uri route.Uri) *route.Pool {
	fake.lookupWithoutWildcardMutex.Lock()
	ret, specificReturn := fake.lookupWithoutWildcardReturnsOnCall[len(fake.lookupWithoutWildcardArgsForCall)]
	fake.lookupWithoutWildcardArgsForCall = append(fake.lookupWithoutWildcardArgsForCall, struct {
		uri route.Uri
	}{uri})
	fake.recordInvocation("LookupWithoutWildcard", []interface{}{uri})
	fake.lookupWithoutWildcardMutex.Unlock()
	if fake.LookupWithoutWildcardStub != nil {
		return fake.LookupWithoutWildcardStub(uri)
	}
	if specificReturn {
		return ret.result1
	}
	return fake.lookupWithoutWildcardReturns.result1
}

func (fake *FakeRegistry) LookupWithoutWildcardCallCount() int {
	fake.lookupWithoutWildcardMutex.RLock()
	defer fake.lookupWithoutWildcardMutex.RUnlock()
	return len(fake.lookupWithoutWildcardArgsForCall)
}

func (fake *FakeRegistry) LookupWithoutWildcardArgsForCall(i int) route.Uri {
	fake.lookupWithoutWildcardMutex.RLock()
	defer fake.lookupWithoutWildcardMutex.RUnlock()
	return fake.lookupWithoutWildcardArgsForCall[i].uri
}

func (fake *FakeRegistry) LookupWithoutWildcardReturns(result1 *route.Pool) {
	fake.LookupWithoutWildcardStub = nil
	fake.lookupWithoutWildcardReturns = struct {
		result1 *route.Pool
	}{result1}
}

func (fake *FakeRegistry) LookupWithoutWildcardReturnsOnCall(i int, result1 *route.Pool) {
	fake.LookupWithoutWildcardStub = nil
	if fake.lookupWithoutWildcardReturnsOnCall == nil {
		fake.lookupWithoutWildcardReturnsOnCall = make(map[int]struct {
			result1 *route.Pool
		})
	}
	fake.lookupWithoutWildcardReturnsOnCall[i] = struct {
		result1 *route.Pool
	}{result1}
}

func (fake *FakeRegistry) WalkNodesWithPool(arg1 func(f *container.Trie)) {
	fake.walkNodesWithPoolMutex.Lock()
	fake.walkNodesWithPoolArgsForCall = append(fake.walkNodesWithPoolArgsForCall, struct {
		arg1 func(f *container.Trie)
	}{arg1})
	fake.recordInvocation("WalkNodesWithPool", []interface{}{arg1})
	fake.walkNodesWithPoolMutex.Unlock()
	if fake.WalkNodesWithPoolStub != nil {
		fake.WalkNodesWithPoolStub(arg1)
	}
}

func (fake *FakeRegistry) WalkNodesWithPoolCallCount() int {
	fake.walkNodesWithPoolMutex.RLock()
	defer fake.walkNodesWithPoolMutex.RUnlock()
	return len(fake.walkNodesWithPoolArgsForCall)
}

func (fake *FakeRegistry) WalkNodesWithPoolArgsForCall(i int) func(f *container.Trie) {
	fake.walkNodesWithPoolMutex.RLock()
	defer fake.walkNodesWithPoolMutex.RUnlock()
	return fake.walkNodesWithPoolArgsForCall[i].arg1
}
