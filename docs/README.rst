...
You can use the |cfctlr| as a `Cloud Foundry Service Broker`_ to apply per-Route configurations to your BIG-IP device(s). See `Deploy the BIG-IP Controller for Cloud Foundry with per-Route Virtual Servers`_ for instructions.
